...
public class WithdrawalSessionCreatedCryptoWalletHandlerTest extends AbstractKafkaTest {
    ...
    public void cryptoWalletTest() {
        ...
        Assert.assertNotNull(result.getResourceCryptoWalletId());
        Assert.assertNotNull(result.getResourceCryptoWalletData());
    }
