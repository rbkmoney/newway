...
public class DestinationCreatedCryptoWalletHandlerTest extends AbstractAppDaoTests {
    ...
    public void destinationCreatedHandlerTest() {
        ...
        Assert.assertNotNull(destinationResult.getResourceCryptoWalletId());
        Assert.assertNotNull(destinationResult.getResourceCryptoWalletData());
    }
