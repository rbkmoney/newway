...
public class DestinationCreatedDigitalWalletHandlerTest extends AbstractAppDaoTests {
    ...
    public void destinationCreatedHandlerTest() {
        ...
        Assert.assertNotNull(destinationResult.getResourceDigitalWalletId());
        Assert.assertNotNull(destinationResult.getResourceDigitalWalletData());
    }
