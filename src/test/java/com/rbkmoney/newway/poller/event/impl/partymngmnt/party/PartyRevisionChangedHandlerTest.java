package com.rbkmoney.newway.poller.event.impl.partymngmnt.party;
...
import com.rbkmoney.newway.poller.event.stock.impl.partymngmnt.party.PartyRevisionChangedHandler;
...
public class PartyRevisionChangedHandlerTest extends AbstractAppDaoTests {
    ...
    public void testPerfomanceHandle() throws SQLException {
        ...
        assertEquals(Integer.valueOf(CNT), jdbcTemplate
