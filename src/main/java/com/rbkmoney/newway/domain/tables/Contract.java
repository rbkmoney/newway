...
public class Contract extends TableImpl<ContractRecord> {
    ...
    private static final long serialVersionUID = 65277637;
     ...
     */
    public final TableField<ContractRecord, ContractStatus> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.ContractStatus.class), this, "");
     ...
     */
    public final TableField<ContractRecord, RepresentativeDocument> REPORT_ACT_SIGNER_DOCUMENT = createField("report_act_signer_document", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.rbkmoney.newway.domain.enums.RepresentativeDocument.class), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.CONTRACT_CONTRACT_ID, Indexes.CONTRACT_CREATED_AT, Indexes.CONTRACT_EVENT_CREATED_AT, Indexes.CONTRACT_EVENT_ID, Indexes.CONTRACT_PARTY_ID, Indexes.CONTRACT_PKEY);
    }
