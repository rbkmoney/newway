...
public class PayoutSummary extends TableImpl<PayoutSummaryRecord> {
    ...
    private static final long serialVersionUID = -786251394;
    ...
    public PayoutSummary() {
        this(DSL.name("payout_summary"), null);
    }
    ...
    public PayoutSummary(String alias) {
        this(DSL.name(alias), PAYOUT_SUMMARY);
    }

    /**
     * Create an aliased <code>nw.payout_summary</code> table reference
     */
    public PayoutSummary(Name alias) {
        this(alias, PAYOUT_SUMMARY);
    }

    private PayoutSummary(Name alias, Table<PayoutSummaryRecord> aliased) {
        this(alias, aliased, null);
    }

    private PayoutSummary(Name alias, Table<PayoutSummaryRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> PayoutSummary(Table<O> child, ForeignKey<O, PayoutSummaryRecord> key) {
        super(child, key, PAYOUT_SUMMARY);
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PAYOUT_SUMMARY_IDX, Indexes.PAYOUT_SUMMARY_PKEY);
    }
    ...
    public Payout payout() {
        return new Payout(this, Keys.PAYOUT_SUMMARY__FK_SUMMARY_TO_PAYOUT);
    }
    ...
    public PayoutSummary as(String alias) {
        return new PayoutSummary(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public PayoutSummary as(Name alias) {
    ...
    public PayoutSummary rename(String name) {
        return new PayoutSummary(DSL.name(name), null);
    }
     ...
     */
    @Override
    public PayoutSummary rename(Name name) {
