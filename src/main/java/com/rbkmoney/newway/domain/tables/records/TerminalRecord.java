...
public class TerminalRecord extends UpdatableRecordImpl<TerminalRecord> implements Record10<Long, Long, Integer, String, String, String, Integer, String, LocalDateTime, Boolean> {

    private static final long serialVersionUID = 1801506043;
     ...
     */
    public void setRiskCoverage(Integer value) {
        set(6, value);
    }
     ...
     */
    @Override
    public Row10<Long, Long, Integer, String, String, String, Integer, String, LocalDateTime, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row10<Long, Long, Integer, String, String, String, Integer, String, LocalDateTime, Boolean> valuesRow() {
     ...
     */
    @Override
    public TerminalRecord value7(Integer value) {
     ...
     */
    @Override
    public TerminalRecord values(Long value1, Long value2, Integer value3, String value4, String value5, String value6, Integer value7, String value8, LocalDateTime value9, Boolean value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TerminalRecord(Long id, Long versionId, Integer terminalRefId, String name, String description, String optionsJson, Integer riskCoverage, String termsJson, LocalDateTime wtime, Boolean current) {
        super(Terminal.TERMINAL);
