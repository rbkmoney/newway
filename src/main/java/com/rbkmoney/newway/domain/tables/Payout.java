...
public class Payout extends TableImpl<PayoutRecord> {
    ...
    private static final long serialVersionUID = -1882824002;
     ...
     */
    public final TableField<PayoutRecord, PayoutStatus> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.PayoutStatus.class), this, "");

    /**
     * The column <code>nw.payout.status_paid_details</code>.
     */
    public final TableField<PayoutRecord, PayoutPaidStatusDetails> STATUS_PAID_DETAILS = createField("status_paid_details", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.rbkmoney.newway.domain.enums.PayoutPaidStatusDetails.class), this, "");
     ...
     */
    public final TableField<PayoutRecord, UserType> STATUS_CANCELLED_USER_INFO_TYPE = createField("status_cancelled_user_info_type", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.rbkmoney.newway.domain.enums.UserType.class), this, "");
     ...
     */
    public final TableField<PayoutRecord, UserType> STATUS_CONFIRMED_USER_INFO_TYPE = createField("status_confirmed_user_info_type", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.rbkmoney.newway.domain.enums.UserType.class), this, "");

    /**
     * The column <code>nw.payout.type</code>.
     */
    public final TableField<PayoutRecord, PayoutType> TYPE = createField("type", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.PayoutType.class), this, "");
     ...
     */
    public final TableField<PayoutRecord, PayoutAccountType> TYPE_ACCOUNT_TYPE = createField("type_account_type", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.rbkmoney.newway.domain.enums.PayoutAccountType.class), this, "");
     ...
     */
    public final TableField<PayoutRecord, UserType> INITIATOR_TYPE = createField("initiator_type", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.UserType.class), this, "");
    ...
    public Payout(String alias) {
        this(DSL.name(alias), PAYOUT);
    }

    /**
     * Create an aliased <code>nw.payout</code> table reference
     */
    public Payout(Name alias) {
        this(alias, PAYOUT);
    }

    private Payout(Name alias, Table<PayoutRecord> aliased) {
        this(alias, aliased, null);
    }

    private Payout(Name alias, Table<PayoutRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> Payout(Table<O> child, ForeignKey<O, PayoutRecord> key) {
        super(child, key, PAYOUT);
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PAYOUT_CREATED_AT, Indexes.PAYOUT_EVENT_CREATED_AT, Indexes.PAYOUT_EVENT_ID, Indexes.PAYOUT_PARTY_ID, Indexes.PAYOUT_PAYOUT_ID, Indexes.PAYOUT_PKEY, Indexes.PAYOUT_STATUS);
    }
    ...
    public Payout as(String alias) {
        return new Payout(DSL.name(alias), this);
    }
    ...
    public Payout rename(String name) {
        return new Payout(DSL.name(name), null);
    }
     ...
     */
    @Override
    public Payout rename(Name name) {
