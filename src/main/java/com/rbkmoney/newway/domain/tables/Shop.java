...
public class Shop extends TableImpl<ShopRecord> {
    ...
    private static final long serialVersionUID = 1638960083;
     ...
     */
    public final TableField<ShopRecord, Blocking> BLOCKING = createField("blocking", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.Blocking.class), this, "");
     ...
     */
    public final TableField<ShopRecord, Suspension> SUSPENSION = createField("suspension", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.Suspension.class), this, "");
     ...
     */
    public final TableField<ShopRecord, LocalDateTime> WTIME = createField("wtime", org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(org.jooq.impl.DSL.field("timezone('utc'::text, now())", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SHOP_CREATED_AT, Indexes.SHOP_EVENT_CREATED_AT, Indexes.SHOP_EVENT_ID, Indexes.SHOP_PARTY_ID, Indexes.SHOP_PKEY, Indexes.SHOP_SHOP_ID);
    }
