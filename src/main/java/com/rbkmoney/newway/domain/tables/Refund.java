...
public class Refund extends TableImpl<RefundRecord> {
    ...
    private static final long serialVersionUID = 1529649575;
     ...
     */
    public final TableField<RefundRecord, RefundStatus> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.RefundStatus.class), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.REFUND_CREATED_AT, Indexes.REFUND_EVENT_CREATED_AT, Indexes.REFUND_EVENT_ID, Indexes.REFUND_INVOICE_ID, Indexes.REFUND_PARTY_ID, Indexes.REFUND_PKEY, Indexes.REFUND_STATUS);
    }
