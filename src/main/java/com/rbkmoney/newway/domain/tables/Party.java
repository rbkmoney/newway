...
public class Party extends TableImpl<PartyRecord> {
    ...
    private static final long serialVersionUID = 2086046999;
     ...
     */
    public final TableField<PartyRecord, Blocking> BLOCKING = createField("blocking", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.Blocking.class), this, "");
     ...
     */
    public final TableField<PartyRecord, Suspension> SUSPENSION = createField("suspension", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.Suspension.class), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PARTY_CONTACT_INFO_EMAIL, Indexes.PARTY_CREATED_AT, Indexes.PARTY_CURRENT, Indexes.PARTY_EVENT_CREATED_AT, Indexes.PARTY_EVENT_ID, Indexes.PARTY_PARTY_ID, Indexes.PARTY_PKEY);
    }
