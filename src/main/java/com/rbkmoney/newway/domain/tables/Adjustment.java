...
public class Adjustment extends TableImpl<AdjustmentRecord> {
    ...
    private static final long serialVersionUID = -733978665;
     ...
     */
    public final TableField<AdjustmentRecord, AdjustmentStatus> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.AdjustmentStatus.class), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ADJUSTMENT_CREATED_AT, Indexes.ADJUSTMENT_EVENT_CREATED_AT, Indexes.ADJUSTMENT_EVENT_ID, Indexes.ADJUSTMENT_INVOICE_ID, Indexes.ADJUSTMENT_PARTY_ID, Indexes.ADJUSTMENT_PKEY, Indexes.ADJUSTMENT_STATUS);
    }
