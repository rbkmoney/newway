...
public class Payment extends TableImpl<PaymentRecord> {
    ...
    private static final long serialVersionUID = -790714093;
     ...
     */
    public final TableField<PaymentRecord, PaymentStatus> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.PaymentStatus.class), this, "");
     ...
     */
    public final TableField<PaymentRecord, PayerType> PAYER_TYPE = createField("payer_type", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.PayerType.class), this, "");

    /**
     * The column <code>nw.payment.payer_payment_tool_type</code>.
     */
    public final TableField<PaymentRecord, PaymentToolType> PAYER_PAYMENT_TOOL_TYPE = createField("payer_payment_tool_type", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.PaymentToolType.class), this, "");
     ...
     */
    public final TableField<PaymentRecord, PaymentFlowType> PAYMENT_FLOW_TYPE = createField("payment_flow_type", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.PaymentFlowType.class), this, "");
     ...
     */
    public final TableField<PaymentRecord, RiskScore> RISK_SCORE = createField("risk_score", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.rbkmoney.newway.domain.enums.RiskScore.class), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PAYMENT_CREATED_AT, Indexes.PAYMENT_EVENT_CREATED_AT, Indexes.PAYMENT_EVENT_ID, Indexes.PAYMENT_INVOICE_ID, Indexes.PAYMENT_PARTY_ID, Indexes.PAYMENT_PKEY, Indexes.PAYMENT_STATUS);
    }
