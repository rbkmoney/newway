...
public class PayoutTool extends TableImpl<PayoutToolRecord> {
    ...
    private static final long serialVersionUID = 275554328;
     ...
     */
    public final TableField<PayoutToolRecord, PayoutToolInfo> PAYOUT_TOOL_INFO = createField("payout_tool_info", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.newway.domain.enums.PayoutToolInfo.class), this, "");
     ...
     */
    public PayoutTool() {
        this(DSL.name("payout_tool"), null);
    }
    ...
    public PayoutTool(String alias) {
        this(DSL.name(alias), PAYOUT_TOOL);
    }

    /**
     * Create an aliased <code>nw.payout_tool</code> table reference
     */
    public PayoutTool(Name alias) {
        this(alias, PAYOUT_TOOL);
    }

    private PayoutTool(Name alias, Table<PayoutToolRecord> aliased) {
        this(alias, aliased, null);
    }

    private PayoutTool(Name alias, Table<PayoutToolRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> PayoutTool(Table<O> child, ForeignKey<O, PayoutToolRecord> key) {
        super(child, key, PAYOUT_TOOL);
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PAYOUT_TOOL_IDX, Indexes.PAYOUT_TOOL_PKEY);
    }
    ...
    public Contract contract() {
        return new Contract(this, Keys.PAYOUT_TOOL__FK_PAYOUT_TOOL_TO_CONTRACT);
    }
    ...
    public PayoutTool as(String alias) {
        return new PayoutTool(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public PayoutTool as(Name alias) {
    ...
    public PayoutTool rename(String name) {
        return new PayoutTool(DSL.name(name), null);
    }
     ...
     */
    @Override
    public PayoutTool rename(Name name) {
