...
public class GetPaymentProviderFeeSfunc1 extends AbstractRoutine<Long[]> {

    private static final long serialVersionUID = -1285483101;
     ...
     */
    public GetPaymentProviderFeeSfunc1() {
