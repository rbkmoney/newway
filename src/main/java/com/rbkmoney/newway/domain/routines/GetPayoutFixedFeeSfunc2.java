...
public class GetPayoutFixedFeeSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -305373803;
    ...
    /**
     * The parameter <code>nw.get_payout_fixed_fee_sfunc.amount</code>.
     */
     ...
     */
    public GetPayoutFixedFeeSfunc2() {
        super("get_payout_fixed_fee_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
