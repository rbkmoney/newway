...
public class GetPaymentExternalFeeSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 900828289;
    ...
    /**
     * The parameter <code>nw.get_payment_external_fee_sfunc.amount</code>.
     */
     ...
     */
    public GetPaymentExternalFeeSfunc2() {
        super("get_payment_external_fee_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
