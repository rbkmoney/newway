...
public class GetPaymentAmountSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 754752877;
    ...
    /**
     * The parameter <code>nw.get_payment_amount_sfunc.amount</code>.
     */
     ...
     */
    public GetPaymentAmountSfunc2() {
        super("get_payment_amount_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
