...
public class GetAdjustmentProviderFeeSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1395213689;
    ...
    /**
     * The parameter <code>nw.get_adjustment_provider_fee_sfunc.amount</code>.
     */
     ...
     */
    public GetAdjustmentProviderFeeSfunc2() {
        super("get_adjustment_provider_fee_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
