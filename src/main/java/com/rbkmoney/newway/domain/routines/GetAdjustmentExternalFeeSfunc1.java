...
public class GetAdjustmentExternalFeeSfunc1 extends AbstractRoutine<Long[]> {

    private static final long serialVersionUID = 354056837;
     ...
     */
    public GetAdjustmentExternalFeeSfunc1() {
