...
public class GetPayoutFeeSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1364572627;
    ...
    /**
     * The parameter <code>nw.get_payout_fee_sfunc.amount</code>.
     */
     ...
     */
    public GetPayoutFeeSfunc2() {
        super("get_payout_fee_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
