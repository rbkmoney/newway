...
public class GetPaymentGuaranteeDepositSfunc1 extends AbstractRoutine<Long[]> {

    private static final long serialVersionUID = -293558351;
     ...
     */
    public GetPaymentGuaranteeDepositSfunc1() {
