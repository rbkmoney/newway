...
public class GetRefundExternalFeeSfunc1 extends AbstractRoutine<Long[]> {

    private static final long serialVersionUID = -418223525;
     ...
     */
    public GetRefundExternalFeeSfunc1() {
