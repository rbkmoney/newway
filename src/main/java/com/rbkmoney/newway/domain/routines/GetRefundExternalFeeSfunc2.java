...
public class GetRefundExternalFeeSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1375809535;
    ...
    /**
     * The parameter <code>nw.get_refund_external_fee_sfunc.amount</code>.
     */
     ...
     */
    public GetRefundExternalFeeSfunc2() {
        super("get_refund_external_fee_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
