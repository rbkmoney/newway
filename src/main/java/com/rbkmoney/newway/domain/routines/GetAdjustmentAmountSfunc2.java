...
public class GetAdjustmentAmountSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1417203213;
    ...
    /**
     * The parameter <code>nw.get_adjustment_amount_sfunc.amount</code>.
     */
     ...
     */
    public GetAdjustmentAmountSfunc2() {
        super("get_adjustment_amount_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
