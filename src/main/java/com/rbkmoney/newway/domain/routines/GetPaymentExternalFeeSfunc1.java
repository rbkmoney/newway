...
public class GetPaymentExternalFeeSfunc1 extends AbstractRoutine<Long[]> {

    private static final long serialVersionUID = -1385332765;
     ...
     */
    public GetPaymentExternalFeeSfunc1() {
