...
public class GetAdjustmentExternalFeeSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1376235115;
    ...
    /**
     * The parameter <code>nw.get_adjustment_external_fee_sfunc.amount</code>.
     */
     ...
     */
    public GetAdjustmentExternalFeeSfunc2() {
        super("get_adjustment_external_fee_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
