...
public class GetPaymentFeeSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -2005416057;
    ...
    /**
     * The parameter <code>nw.get_payment_fee_sfunc.amount</code>.
     */
     ...
     */
    public GetPaymentFeeSfunc2() {
        super("get_payment_fee_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
