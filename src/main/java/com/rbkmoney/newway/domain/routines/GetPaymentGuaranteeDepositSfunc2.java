...
public class GetPaymentGuaranteeDepositSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1558597087;
    ...
    /**
     * The parameter <code>nw.get_payment_guarantee_deposit_sfunc.amount</code>.
     */
     ...
     */
    public GetPaymentGuaranteeDepositSfunc2() {
        super("get_payment_guarantee_deposit_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
