...
public class GetPayoutAmountSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1667742719;
    ...
    /**
     * The parameter <code>nw.get_payout_amount_sfunc.amount</code>.
     */
     ...
     */
    public GetPayoutAmountSfunc2() {
        super("get_payout_amount_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
