...
public class GetPaymentProviderFeeSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1942446529;
    ...
    /**
     * The parameter <code>nw.get_payment_provider_fee_sfunc.amount</code>.
     */
     ...
     */
    public GetPaymentProviderFeeSfunc2() {
        super("get_payment_provider_fee_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
