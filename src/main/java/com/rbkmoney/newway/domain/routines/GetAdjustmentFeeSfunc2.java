...
public class GetAdjustmentFeeSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -913610099;
    ...
    /**
     * The parameter <code>nw.get_adjustment_fee_sfunc.amount</code>.
     */
     ...
     */
    public GetAdjustmentFeeSfunc2() {
        super("get_adjustment_fee_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
