...
public class GetRefundProviderFeeSfunc1 extends AbstractRoutine<Long[]> {

    private static final long serialVersionUID = -57065585;
     ...
     */
    public GetRefundProviderFeeSfunc1() {
