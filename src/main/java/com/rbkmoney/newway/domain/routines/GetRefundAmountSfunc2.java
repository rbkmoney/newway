...
public class GetRefundAmountSfunc2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1268728669;
    ...
    /**
     * The parameter <code>nw.get_refund_amount_sfunc.amount</code>.
     */
     ...
     */
    public GetRefundAmountSfunc2() {
        super("get_refund_amount_sfunc", Nw.NW, org.jooq.impl.SQLDataType.BIGINT);
