...
public class DepositTransferStatusChangedHandler extends AbstractDepositHandler {
    ...
    public void handle(Change change, MachineEvent event, Integer changeId) {
        ...
        log.info("Start deposit transfer status changed handling, sequenceId={}, depositId={}, changeId={}", sequenceId, depositId, changeId);
        ...
        depositDao.save(deposit).ifPresentOrElse(
                ...
                () -> log.info("Withdrawal deposit status have been changed, sequenceId={}, depositId={}, changeId={}",
