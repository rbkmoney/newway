...
public class DestinationAccountCreatedHandler extends AbstractDestinationHandler {
    ...
    public void handle(TimestampedChange timestampedChange, MachineEvent event) {
        ...
        log.info("Start destination account created handling, sequenceId={}, destinationId={}", sequenceId, destinationId);
        ...
        destinationDao.save(destination).ifPresentOrElse(
                id -> {
                    ...
                    log.info("Destination account have been changed, sequenceId={}, destinationId={}", sequenceId, destinationId);
                },
