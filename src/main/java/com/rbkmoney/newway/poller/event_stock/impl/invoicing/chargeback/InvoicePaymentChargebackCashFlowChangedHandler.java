...
public class InvoicePaymentChargebackCashFlowChangedHandler extends AbstractInvoicingHandler {
    ...
    public void handle(InvoiceChange change, MachineEvent event, Integer changeId) {
        ...
        log.info("Start chargeback cash flow changed handling, sequenceId={}, invoiceId={}, paymentId={}, chargebackId={}",
        ...
        log.info("Chargeback cash flow changed have been succeeded, sequenceId={}, invoiceId={}, paymentId={}, chargebackId={}",
                sequenceId, invoiceId, paymentId, chargebackId);
    }
