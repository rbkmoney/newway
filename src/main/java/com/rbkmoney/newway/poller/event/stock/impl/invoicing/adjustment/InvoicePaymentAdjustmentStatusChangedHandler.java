package com.rbkmoney.newway.poller.event.stock.impl.invoicing.adjustment;
...
public class InvoicePaymentAdjustmentStatusChangedHandler extends AbstractInvoicingHandler {
    ...
    public void handle(InvoiceChange invoiceChange, MachineEvent event, Integer changeId) {
        ...
        log.info(
                "Start adjustment status changed handling, " +
        ...
        if (invoicePaymentAdjustmentStatus.isSetCaptured()) {
            adjustmentSource.setStatusCapturedAt(
            ...
            adjustmentSource.setStatusCancelledAt(
        ...
        if (adjId != null) {
            ...
            List<CashFlow> newCashFlows =
                    cashFlowDao.getForAdjustments(adjustmentSourceId, AdjustmentCashFlowType.new_cash_flow);
            ...
            List<CashFlow> oldCashFlows =
                    cashFlowDao.getForAdjustments(adjustmentSourceId, AdjustmentCashFlowType.old_cash_flow_inverse);
        ...
        log.info(
                "Adjustment status change has been saved, " +
                        "sequenceId={}, invoiceId={}, paymentId={}, adjustmentId={}, status={}",
                sequenceId, invoiceId, paymentId, adjustmentId,
                invoicePaymentAdjustmentStatus.getSetField().getFieldName());
    }
