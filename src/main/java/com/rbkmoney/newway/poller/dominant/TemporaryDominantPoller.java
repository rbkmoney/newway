...
public class TemporaryDominantPoller {

    private final Logger log = LoggerFactory.getLogger(this.getClass());

    private final RepositorySrv.Iface dominantClient;
    private final TemporaryDominantService dominantService;
    private final int maxQuerySize;
    private final boolean pollingEnabled;
    private long after;

    public TemporaryDominantPoller(RepositorySrv.Iface dominantClient,
