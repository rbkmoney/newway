...
public class ShopCreatedHandler extends AbstractClaimChangedHandler {
    ...
    public void handle(PartyChange change, Event event) {
        getClaimStatus(change).getAccepted().getEffects().stream()
                .filter(e -> e.isSetShopEffect() && e.getShopEffect().getEffect().isSetCreated()).forEach(e -> processShopCreated(event, e));
    }

    private void processShopCreated(Event event, ClaimEffect e) {
